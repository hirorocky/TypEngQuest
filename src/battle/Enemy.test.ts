...
describe('Enemy', () => {
  ...
  // --- Merged from Enemy.phase3.test.ts ---
  describe('Phase 3: 回避率システムとMP除去', () => {
    describe('回避率システム（物理・魔法）', () => {
      ...
      beforeEach(() => {
        enemy = new Enemy({
          ...
          level: 6,
          stats: { maxHp: 100, strength: 15, willpower: 12, agility: 120, fortune: 20 },
          physicalEvadeRate: 25,
          magicalEvadeRate: 10,
        });
      });
      ...
      it('回避率が0-100範囲外の場合はエラーになる', () => {
        expect(() => {
          new Enemy({
            ...
            description: 'Invalid',
            level: 1,
            stats: { maxHp: 50, strength: 10, willpower: 5, agility: 78, fortune: 5 },
    ...
    describe('MP除去による簡素化', () => {
      ...
      beforeEach(() => {
        enemy = new Enemy({
          ...
          level: 3,
          stats: { maxHp: 80, strength: 12, willpower: 8, agility: 85, fortune: 10 },
          physicalEvadeRate: 15,
          magicalEvadeRate: 8,
        });
      });
      ...
      it('技選択にMPの制限がない', () => {
        const enemyWithSkills = new Enemy({
          ...
          level: 5,
          stats: { maxHp: 120, strength: 20, willpower: 15, agility: 95, fortune: 12 },
          physicalEvadeRate: 20,
          magicalEvadeRate: 5,
          skills: [
            {
              ...
              effects: [
                {
                  ...
                  target: 'enemy',
                  basePower: 120,
                  powerInfluence: { stat: 'strength', rate: 2.0 },
                  successRate: 95,
                },
              ],
            },
