...
**成果物**:
- cat, head, file, vim, chmod コマンドが動作する
- ファイル内容の表示機能
...
### 📂 プロジェクト4B: ファイルタイプ判定システム
**目標**: ファイルタイプに応じた処理を実装する
...
**タスク**:
1. FileTypeManagerの実装
2. モンスター戦闘への遷移機能
3. 宝箱アイテム取得機能
4. セーブポイント機能
5. イベント発動機能

**チェックポイント**: ファイルタイプに応じた特別な処理が動作すること
