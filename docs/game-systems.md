...
- **マナポーション**: MPを回復するアイテム
- **バフアイテム**: 一時的にステータスを上昇させるアイテム
- **デバフアイテム**: 一時的に敵のステータスを低下させるアイテム
- **状態異常回復アイテム**: 毒や麻痺などの状態異常を回復するアイテム
- **状態異常付与アイテム**: 毒や麻痺などの状態異常を付与するアイテム
...
- **行動選択**: プレイヤーは「技使用」「アイテム使用」「逃走」を選択
  ...
  - **アイテム使用**: 消費アイテムを使用して効果を発動させる（タイピングチャレンジは行わない）
