...
## プレイヤーシステム
- **ステータス**: プレイヤーの基本能力値。HP、MP、攻撃力、防御力、速度、精度、幸運を持つ
- **レベル**: プレイヤーの成長度合いを示す。装備アイテムのグレード平均値。
- **状態**: プレイヤーの現在の状態。バフやデバフ、状態異常を持つ。
...
- 装備アイテムは個別のステータスを持つ:
  - attack: 攻撃力。敵に与えるダメージに影響
  - defense: 防御力。敵から受けるダメージに影響
  - speed: 速度。回避率、タイピングスピードボーナス倍率に影響
  - accuracy: 精度。命中率、タイピング精度ボーナス倍率に影響
  - fortune: 幸運。クリティカル率、特殊効果成功率、アイテムドロップ率に影響
